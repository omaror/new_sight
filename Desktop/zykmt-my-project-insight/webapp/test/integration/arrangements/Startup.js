sap.ui.define([
	"sap/ui/test/Opa5",
	"zymkt/my/project/insigth/ZYKMT_MY_PROJECT_INSIGHT/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("zymkt.my.project.insigth.ZYKMT_MY_PROJECT_INSIGHT.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "zymkt.my.project.insigth.ZYKMT_MY_PROJECT_INSIGHT",
					async: true
				},
				hash: oOptions.hash,
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "ContactOriginData/" + encodeURIComponent(sObjectId);
