sap.ui.define([
	...
	return Opa5.extend("zymkt.my.project.insigth.ZYKMT_MY_PROJECT_INSIGHT.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["zymkt/my/project/insigth/ZYKMT_MY_PROJECT_INSIGHT/localService/mockserver"], function (mockserver) {
