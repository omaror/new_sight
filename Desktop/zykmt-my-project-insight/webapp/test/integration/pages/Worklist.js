		...
		onTheWorklistPage : {
					...
					return this.waitFor(createWaitForItemAtPosition({
						...
						success : function (oTableItem) {
							...
							this.getContext().currentItem = {
								...
								id: oBindingContext.getProperty("ContactID"),
								name: oBindingContext.getProperty("AddressHouseNumber")
							};
						}
					}));
				},
			...
			assertions: Object.assign({
				...
				theTableShouldHaveAllEntries : function () {
					...
					// retrieve all ContactOriginData to be able to check for the total amount
					this.waitFor(this.createAWaitForAnEntitySet({
						entitySet: "ContactOriginData",
